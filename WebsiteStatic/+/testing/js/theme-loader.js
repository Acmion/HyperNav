...
function loadTheme(theme)
{
    ...
    if (theme == "Default")
    {
        ...
        stylesheetLinkElement.href = "../dist/css/hyper-nav-default.min.css";
    ...
    else if (theme == "Highlight")
    {
        var stylesheetLinkElement = document.createElement("link");
        stylesheetLinkElement.rel = "stylesheet";
        stylesheetLinkElement.href = "../dist/css/themes/highlight/variables.min.css";
    ...
    else if (theme == "Technical")
    {
        var stylesheetLinkElement = document.createElement("link");
        stylesheetLinkElement.rel = "stylesheet";
        stylesheetLinkElement.href = "../dist/css/themes/technical/variables.min.css";
    ...
    else if (theme == "Bluelight")
    {
        var stylesheetLinkElement = document.createElement("link");
        stylesheetLinkElement.rel = "stylesheet";
        stylesheetLinkElement.href = "../dist/css/themes/bluelight/variables.min.css";
